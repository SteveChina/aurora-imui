//
//  RCTMessageListViewGroupManager.m
//  imuiDemo
//
...
#import "RCTMessageListViewGroup.h"
#import <RCTAuroraIMUI/RCTAuroraIMUI-Swift.h>

@interface RCTMessageListViewGroupManager : RCTViewManager <IMUIMessageMessageCollectionViewDelegate>

//@property (nonatomic, copy) RCTBubblingEventBlock messageListEventCallBack;
@property (strong, nonatomic)RCTMessageListViewGroup *messageList;
...
@implementation RCTMessageListViewGroupManager
...
- (UIView *)view
{
  ...
  _messageList = [[bundle loadNibNamed:@"RCTMessageListViewGroup" owner:self options: nil] objectAtIndex:0];
...
RCT_CUSTOM_VIEW_PROPERTY(sendBubble, NSDictionary, RCTMessageListViewGroup) {
...
RCT_CUSTOM_VIEW_PROPERTY(receiveBubble, NSDictionary, RCTMessageListViewGroup) {
  NSDictionary *bubbleDic = [RCTConvert NSDictionary: json];
  NSString *bubbleName = bubbleDic[@"imageName"];
...
RCT_CUSTOM_VIEW_PROPERTY(messageListBackgroundColor, NSString, RCTMessageListViewGroup) {
...
RCT_CUSTOM_VIEW_PROPERTY(maxBubbleWidth, NSNumber, RCTMessageListViewGroup) {
...
RCT_CUSTOM_VIEW_PROPERTY(sendBubbleTextColor, NSString, RCTMessageListViewGroup) {
  NSString *colorString = [RCTConvert NSString: json];
  UIColor *color = [UIColor hexStringToUIColorWithHex:colorString];
  if (color != nil) {
...
RCT_CUSTOM_VIEW_PROPERTY(receiveBubbleTextColor, NSString, RCTMessageListViewGroup) {
  NSString *colorString = [RCTConvert NSString: json];
  UIColor *color = [UIColor hexStringToUIColorWithHex:colorString];
  if (color != nil) {
...
RCT_CUSTOM_VIEW_PROPERTY(sendBubbleTextSize, NSNumber, RCTMessageListViewGroup) {
...
RCT_CUSTOM_VIEW_PROPERTY(receiveBubbleTextSize, NSNumber, RCTMessageListViewGroup) {
  NSNumber *textSize = [RCTConvert NSNumber: json];
  IMUITextMessageContentView.inComingTextFont = [UIFont systemFontOfSize:[textSize floatValue]];
}

RCT_CUSTOM_VIEW_PROPERTY(dateTextSize, NSNumber, RCTMessageListViewGroup) {
...
RCT_CUSTOM_VIEW_PROPERTY(dateTextColor, NSString, RCTMessageListViewGroup) {
  NSString *colorString = [RCTConvert NSString: json];
  UIColor *color = [UIColor hexStringToUIColorWithHex:colorString];
  if (color != nil) {
...
RCT_CUSTOM_VIEW_PROPERTY(avatarSize, NSDictionary, RCTMessageListViewGroup) {
...
RCT_CUSTOM_VIEW_PROPERTY(isShowDisplayName, BOOL, RCTMessageListViewGroup) {
...
RCT_CUSTOM_VIEW_PROPERTY(isShowOutgoingDisplayName, BOOL, RCTMessageListViewGroup) {
  BOOL needShowDisPlayName = [RCTConvert BOOL: json];
  IMUIMessageCellLayout.isNeedShowOutGoingName = needShowDisPlayName;
}

RCT_CUSTOM_VIEW_PROPERTY(isShowIncomingDisplayName, BOOL, RCTMessageListViewGroup) {
  BOOL needShowDisPlayName = [RCTConvert BOOL: json];
  IMUIMessageCellLayout.isNeedShowInComingName = needShowDisPlayName;
}

RCT_CUSTOM_VIEW_PROPERTY(isAllowPullToRefresh, BOOL, RCTMessageListViewGroup) {
  BOOL needShowDisPlayName = [RCTConvert BOOL: json];
  _messageList.isAllowPullToRefresh = needShowDisPlayName;
}

RCT_CUSTOM_VIEW_PROPERTY(sendBubblePadding, NSDictionary, RCTMessageListViewGroup) {
...
RCT_CUSTOM_VIEW_PROPERTY(avatarCornerRadius, NSDictionary, RCTMessageListViewGroup) {
  NSNumber *cornerRadius = [RCTConvert NSNumber: json];
  IMUIBaseMessageCell.avatarCornerRadius = [cornerRadius floatValue];
  
}

RCT_CUSTOM_VIEW_PROPERTY(receiveBubblePadding, NSDictionary, RCTMessageListViewGroup) {
  NSDictionary *paddingDic = [RCTConvert NSDictionary: json];
  UIEdgeInsets padding = [self edgeInsetsWith:paddingDic];
  MyMessageCellLayout.incommingPadding = padding;
}

RCT_CUSTOM_VIEW_PROPERTY(eventTextColor, NSString, RCTMessageListViewGroup) {
  NSString *colorString = [RCTConvert NSString: json];
  UIColor *color = [UIColor hexStringToUIColorWithHex:colorString];
  if (color != nil) {
...
RCT_CUSTOM_VIEW_PROPERTY(eventTextSize, NSNumber, RCTMessageListViewGroup) {
...
RCT_CUSTOM_VIEW_PROPERTY(eventTextPadding, NSDictionary, RCTMessageListViewGroup) {
  NSDictionary *paddingDic = [RCTConvert NSDictionary: json];
  UIEdgeInsets padding = [self edgeInsetsWith:paddingDic];
  MessageEventCollectionViewCell.contentInset = padding;
}

RCT_CUSTOM_VIEW_PROPERTY(displayNamePadding, NSDictionary, RCTMessageListViewGroup) {
  NSDictionary *paddingDic = [RCTConvert NSDictionary: json];
  UIEdgeInsets padding = [self edgeInsetsWith:paddingDic];
...
RCT_CUSTOM_VIEW_PROPERTY(dateBackgroundColor, NSString, RCTMessageListViewGroup) {
  NSString *colorString = [RCTConvert NSString: json];
  UIColor *color = [UIColor hexStringToUIColorWithHex:colorString];
  if (color != nil) {
...
RCT_CUSTOM_VIEW_PROPERTY(eventBackgroundColor, NSString, RCTMessageListViewGroup) {
  NSString *colorString = [RCTConvert NSString: json];
  UIColor *color = [UIColor hexStringToUIColorWithHex:colorString];
  if (color != nil) {
...
RCT_CUSTOM_VIEW_PROPERTY(displayNameTextColor, NSString, RCTMessageListViewGroup) {
  NSString *colorString = [RCTConvert NSString: json];
  UIColor *color = [UIColor hexStringToUIColorWithHex:colorString];
  if (color != nil) {
...
RCT_CUSTOM_VIEW_PROPERTY(dateCornerRadius, NSNumber, RCTMessageListViewGroup) {
  NSNumber *cornerRadius = [RCTConvert NSNumber: json];
  IMUIMessageCellLayout.timeStringCornerRadius = cornerRadius.floatValue;
}

RCT_CUSTOM_VIEW_PROPERTY(eventCornerRadius, NSNumber, RCTMessageListViewGroup) {
  NSNumber *cornerRadius = [RCTConvert NSNumber: json];
  MessageEventCollectionViewCell.eventCornerRadius = cornerRadius.floatValue;
}

RCT_CUSTOM_VIEW_PROPERTY(displayNameTextSize, NSNumber, RCTMessageListViewGroup) {
  NSNumber *textSize = [RCTConvert NSNumber: json];
...
RCT_CUSTOM_VIEW_PROPERTY(datePadding, NSDictionary, RCTMessageListViewGroup) {
  NSDictionary *paddingDic = [RCTConvert NSDictionary: json];
  UIEdgeInsets padding = [self edgeInsetsWith:paddingDic];
...
RCT_CUSTOM_VIEW_PROPERTY(eventTextLineHeight, NSNumber, RCTMessageListViewGroup) {
  NSNumber *lineHeight = [RCTConvert NSNumber: json];
  // TODO:
}

RCT_CUSTOM_VIEW_PROPERTY(messageTextLineHeight, NSNumber, RCTMessageListViewGroup) {
  NSNumber *lineHeight = [RCTConvert NSNumber: json];
  // TODO:
}
