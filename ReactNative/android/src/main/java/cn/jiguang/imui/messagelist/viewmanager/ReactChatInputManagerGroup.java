...
//            }
    ...
    public void setBackgroundColor(ChatInputView chatInputView, String color) {
        ...
        chatInputView.getChatInputContainer().setBackgroundColor(colorRes);

        LinearLayout.LayoutParams lp = (LinearLayout.LayoutParams) chatInputView.getChatInputContainer().getLayoutParams();
        lp.setMargins(0,0,0,0);

        chatInputView.getChatInputContainer().setPadding(0,22,0,0);
    }

    @ReactProp(name = "textInputBgColor")
    public void textInputBgColor(ChatInputView chatInputView, String color) {
        if(color.equals("#ffffff")) {
            //return;
        }
        int colorRes = Color.parseColor(color);
        chatInputView.getInputView().setBackgroundColor(colorRes);
        //chatInputView.getInputView().setAlpha((float)0.5);
    }
